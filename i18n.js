const I18n = (function() {
    ...
    const translations = {
        en: {
            ...
            labelPrivateLanHttpAuth: 'LAN authentication',
            hintPrivateLanHttpAuth: 'Send the API key to this private HTTP server',
            ...
            labelTranslationIdle: "Turn off translation when idle",
            hintTranslationIdle: "Each translation restarts the timer across tabs. Existing translations stay.",
            unitMinutes: "min",
            ...
            shortcutSitesTitle: "Website exceptions",
            shortcutSitesHint: "These sites use their own shortcut setting. Restore default to follow your global shortcut.",
            shortcutSiteRestore: "Restore default",
            shortcutSiteOff: 'off',
        ...
        zh: {
            ...
            hintBaseUrl: 'OpenAI：https://api.openai.com/v1',
            labelPrivateLanHttpAuth: '局域网认证',
            hintPrivateLanHttpAuth: '向当前私网 HTTP 服务发送 API 密钥',
            ...
            labelTranslationIdle: "闲置后关闭翻译模式",
            hintTranslationIdle: "任意标签页发起翻译都会重新计时，已有译文保留。",
            unitMinutes: "分钟",
            labelShortcutEnabled: '键盘快捷键',
            hintShortcutEnabled: '点击重新绑定；按住 {mod} 可要求 {mod}',
            shortcutRecording: '按任意键…',
            shortcutSitesTitle: "网站快捷键例外",
            shortcutSitesHint: "以下网站使用单独的快捷键设置，恢复默认后将跟随全局设置。",
            shortcutSiteRestore: "恢复默认",
            shortcutSiteOff: '关闭',
        ...
        ja: {
            ...
            hintBaseUrl: 'OpenAI: https://api.openai.com/v1',
            labelPrivateLanHttpAuth: 'LAN 認証',
            hintPrivateLanHttpAuth: 'このプライベート HTTP サーバーに API キーを送信',
            ...
            labelTranslationIdle: "未使用時に翻訳モードをオフ",
            hintTranslationIdle: "どのタブでも翻訳するたびにタイマーがリセットされます。翻訳済みの文は残ります。",
            unitMinutes: "分",
            labelShortcutEnabled: 'キーボードショートカット',
            hintShortcutEnabled: 'クリックで再設定、{mod} 併用で {mod} 必須に',
            shortcutRecording: '任意のキーを押してください…',
            shortcutSitesTitle: "サイト別ショートカット",
            shortcutSitesHint: "これらのサイトには個別の設定があります。初期設定に戻すと全体の設定に従います。",
            shortcutSiteRestore: "初期設定に戻す",
            shortcutSiteOff: 'オフ',
        ...
        fr: {
            ...
            hintBaseUrl: 'OpenAI: https://api.openai.com/v1',
            labelPrivateLanHttpAuth: 'Authentification LAN',
            hintPrivateLanHttpAuth: 'Envoyer la clé API à ce serveur HTTP privé',
            ...
            labelTranslationIdle: "Désactiver la traduction après inactivité",
            hintTranslationIdle: "Chaque traduction relance le délai pour tous les onglets. Les traductions restent affichées.",
            unitMinutes: "min",
            ...
            shortcutSitesTitle: "Exceptions par site",
            shortcutSitesHint: "Ces sites ont un raccourci spécifique. Rétablissez le réglage par défaut pour suivre le raccourci global.",
            shortcutSiteRestore: "Rétablir par défaut",
        ...
        de: {
            ...
            hintBaseUrl: 'OpenAI: https://api.openai.com/v1',
            labelPrivateLanHttpAuth: 'LAN-Authentifizierung',
            hintPrivateLanHttpAuth: 'API-Schlüssel an diesen privaten HTTP-Server senden',
            ...
            labelTranslationIdle: "Übersetzungsmodus bei Inaktivität ausschalten",
            hintTranslationIdle: "Jede Übersetzung startet den Timer für alle Tabs neu. Vorhandene Übersetzungen bleiben erhalten.",
            unitMinutes: "Min.",
            ...
            shortcutSitesTitle: "Website-Ausnahmen",
            shortcutSitesHint: "Diese Websites nutzen eigene Kürzel. Mit dem Standard gilt wieder das globale Kürzel.",
            shortcutSiteRestore: "Standard verwenden",
            shortcutSiteOff: 'aus',
        ...
        es: {
            ...
            hintBaseUrl: 'OpenAI: https://api.openai.com/v1',
            labelPrivateLanHttpAuth: 'Autenticación LAN',
            hintPrivateLanHttpAuth: 'Enviar la clave API a este servidor HTTP privado',
            ...
            labelTranslationIdle: "Desactivar la traducción por inactividad",
            hintTranslationIdle: "Cada traducción reinicia el temporizador en todas las pestañas. Se conservan las traducciones.",
            unitMinutes: "min",
            ...
            shortcutSitesTitle: "Excepciones por sitio",
            shortcutSitesHint: "Estos sitios usan un atajo propio. Restablece el predeterminado para usar el atajo global.",
            shortcutSiteRestore: "Restablecer",
        ...
        ko: {
            ...
            hintBaseUrl: 'OpenAI: https://api.openai.com/v1',
            labelPrivateLanHttpAuth: 'LAN 인증',
            hintPrivateLanHttpAuth: '이 사설 HTTP 서버에 API 키 보내기',
            ...
            labelTranslationIdle: "미사용 시 번역 모드 끄기",
            hintTranslationIdle: "어느 탭에서든 번역하면 타이머가 초기화됩니다. 기존 번역은 유지됩니다.",
            unitMinutes: "분",
            labelShortcutEnabled: '키보드 단축키',
            hintShortcutEnabled: '클릭하면 재설정, {mod}를 함께 누르면 {mod} 조합',
            shortcutRecording: '아무 키나 누르세요…',
            shortcutSitesTitle: "사이트별 단축키 예외",
            shortcutSitesHint: "아래 사이트는 별도 설정을 사용합니다. 기본값으로 복원하면 전체 설정을 따릅니다.",
            shortcutSiteRestore: "기본값 복원",
            shortcutSiteOff: '끔',
        ...
        pt: {
            ...
            hintBaseUrl: 'OpenAI: https://api.openai.com/v1',
            labelPrivateLanHttpAuth: 'Autenticação LAN',
            hintPrivateLanHttpAuth: 'Enviar a chave da API para este servidor HTTP privado',
            ...
            labelTranslationIdle: "Desativar a tradução por inatividade",
            hintTranslationIdle: "Cada tradução reinicia o temporizador em todas as abas. As traduções existentes permanecem.",
            unitMinutes: "min",
            ...
            shortcutSitesTitle: "Exceções por site",
            shortcutSitesHint: "Estes sites usam um atalho próprio. Restaure o padrão para usar o atalho global.",
            shortcutSiteRestore: "Restaurar padrão",
        ...
        ru: {
            ...
            hintBaseUrl: 'OpenAI: https://api.openai.com/v1',
            labelPrivateLanHttpAuth: 'Аутентификация LAN',
            hintPrivateLanHttpAuth: 'Отправлять API-ключ этому частному HTTP-серверу',
            ...
            labelTranslationIdle: "Выключать перевод при бездействии",
            hintTranslationIdle: "Перевод в любой вкладке сбрасывает таймер. Готовые переводы сохраняются.",
            unitMinutes: "мин",
            ...
            shortcutSitesTitle: "Исключения для сайтов",
            shortcutSitesHint: "Для этих сайтов заданы свои сочетания. Восстановите стандартное, чтобы использовать общую настройку.",
            shortcutSiteRestore: "По умолчанию",
        ...
        it: {
            ...
            hintBaseUrl: 'OpenAI: https://api.openai.com/v1',
            labelPrivateLanHttpAuth: 'Autenticazione LAN',
            hintPrivateLanHttpAuth: 'Invia la chiave API a questo server HTTP privato',
            ...
            labelTranslationIdle: "Disattiva la traduzione dopo inattività",
            hintTranslationIdle: "Ogni traduzione riavvia il timer per tutte le schede. Le traduzioni esistenti restano.",
            unitMinutes: "min",
            ...
            shortcutSitesTitle: "Eccezioni per sito",
            shortcutSitesHint: "Questi siti usano una scorciatoia specifica. Ripristina quella predefinita per seguire la scelta globale.",
            shortcutSiteRestore: "Ripristina",
